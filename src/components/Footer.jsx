...
function Footer() {
  return (
    <div data-aos="fade-up" style={{ width: "100%", height: "40vh", backgroundColor: "#367588" }} className="d-flex justify-content-center align-items-center flex-column w-100 mt-1 ">
      <div className="container-fluid my-5 mt-3">
        <div className="row">
          <div className="col-lg-4 col-12">
            <div className="ms-5" style={{ marginTop: "120px" }}>
              <h3 className=" text ms-5 mt-5">Connect On</h3>
          ...
          <div className="col-lg-4 col-12">
            <div className="ms-3 mb-2">
              ...
              <ul className="list-unstyled text-succes fs-5 mt-3">
                <h3 className="text mt-5 mb-4" style={{ textDecoration: "none", marginLeft: "90px" }}>
                  {" "}
                  Contact Us
                </h3>
                <li
